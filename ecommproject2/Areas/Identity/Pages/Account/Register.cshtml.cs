...
namespace ecommproject2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            Input = new InputModel()
            {
                ...
                RoleList = _roleManager.Roles.Where(r => r.Name != SD.Role_Individual).Select(rl => rl.Name)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //////this above line helps to make sure that there willbe only one Admin in project
                    //////after giving 1 admin comment this line.
                    ///
